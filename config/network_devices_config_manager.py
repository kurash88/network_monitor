...
class NetworkDeviceExtractConfigCommands:
...
class NetworkDevicesConfigManager:
    ...
    def get_config_command(self, device: dict) -> str:
        ...
        return NetworkDeviceExtractConfigCommands.get_config_command({'device_type': device_type})
