...
from core.async_poll_starter import AsyncPollStarter
...
class AdvancedNetworkMonitor:
    ...
    def __init__(self, config_path: str = None, poll_interval: int = 60, 
        ...
        self.config_manager = NetworkDevicesConfigManager(self.config_path)
        self.config_collector = NetworkDevicePoller(self.config_manager)
        self.config_saver = NetworkDevicesExtractedConfigsSaver()
        self.status_tracker = NetworkDeviceStatusTracker()
        self.device_poller = AsyncPollStarter(
